...
class SubscriberList extends Model
{
 ...
 protected $table = 'subscriber_list';
     ...
     */
    protected $fillable = ['user_id','office_belongs_to','political_party','gender','dob','off_pos_pol_party','rep_area_off_party_pos','elec_off_pos_name','rep_area_elec_off_pos',
    ...
    'country_eo','state_eo','district_eo','lac_eo','pc_eo','mc1_eo','mc2_eo','cc_eo','block_eo','ward_eo','sub_district_eo','village_eo','bio','allowed_submission','status','is_deleted'];
