            ...
            <div id="requestsContainer">
                ...
                <div class="form-row ">
                    ...
                    <div class="form-group col-md-12" >
                        <button type="button" id="designation_delete_submit" name="designation_delete_submit" class="btn btn-dialog" onclick="updateDesignations('delete');">Delete Selected</button>
                        <button type="button" id="designation_enable_submit" name="designation_enable_submit" class="btn btn-dialog" onclick="updateDesignations('enable');">Enable Selected</button>
                        <button type="button" id="designation_disable_submit" name="designation_disable_submit" class="btn btn-dialog" onclick="updateDesignations('disable');">Disable Selected</button>
                   </div>    
                </div>
                <div class="separator-10">&nbsp;</div>
            </div>
