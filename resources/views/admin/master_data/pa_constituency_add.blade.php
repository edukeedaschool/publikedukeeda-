                ...
                <form class="" name="addConstituencyFrm" id="addConstituencyFrm" type="POST">
                    ...
                    <div class="form-row ">
                        ...
                        <div class="form-group col-md-6" style="text-align:center; ">
                           ...
                           <button type="button" id="constituency_add_cancel" name="constituency_add_cancel" class="btn btn-secondary" data-dismiss="modal" onclick="window.location.href='{{url('pa-constituency/list')}}'">Cancel</button>
                           <button type="button" id ="constituency_add_submit" name="constituency_add_submit" class="btn btn-dialog" onclick="submitAddPAConstituency();">Submit</button>
                       </div>    
                    </div>  
                </form>
            </div>
