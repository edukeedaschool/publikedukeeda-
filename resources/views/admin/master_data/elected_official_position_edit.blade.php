                   ...
                   <div class="form-row">
                    ...
                    <div class="form-row ">
                        ...
                        <div class="form-group col-md-6" style="text-align:center; ">
                           ...
                           <button type="button" id="position_edit_cancel" name="position_edit_cancel" class="btn btn-secondary" data-dismiss="modal" onclick="window.location.href='{{url('elected-official-position/list')}}'">Cancel</button>
                           <button type="button" id ="position_edit_submit" name="position_edit_submit" class="btn btn-dialog" onclick="submitEditElectedOfficialPosition();">Submit</button>
                       </div>    
                    </div>  
                </form>
            </div>
