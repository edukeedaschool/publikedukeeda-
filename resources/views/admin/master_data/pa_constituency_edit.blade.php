                ...
                <form class="" name="editConstituencyFrm" id="editConstituencyFrm" type="POST">
                    ...
                    <div class="form-row ">
                        ...
                        <div class="form-group col-md-6" style="text-align:center; ">
                           ...
                           <button type="button" id="constituency_edit_cancel" name="constituency_edit_cancel" class="btn btn-secondary" data-dismiss="modal" onclick="window.location.href='{{url('pa-constituency/list')}}'">Cancel</button>
                           <button type="button" id ="constituency_edit_submit" name="constituency_edit_submit" class="btn btn-dialog" onclick="submitEditPAConstituency();">Submit</button>
                       </div>    
                    </div>  
                </form>
            </div>
