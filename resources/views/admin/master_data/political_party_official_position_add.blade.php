                ...
                <form class="" name="addPositionFrm" id="addPositionFrm" type="POST">
                    ...
                    <div class="form-row ">
                        ...
                        <div class="form-group col-md-6" style="text-align:center; ">
                           ...
                           <button type="button" id="position_add_cancel" name="position_add_cancel" class="btn btn-secondary" data-dismiss="modal" onclick="window.location.href='{{url('political-party-official-position/list')}}'">Cancel</button>
                           <button type="button" id ="position_add_submit" name="position_add_submit" class="btn btn-dialog" onclick="submitAddPoliticalPartyOfficialPosition();">Submit</button>
                       </div>    
                    </div>  
                </form>
            </div>
