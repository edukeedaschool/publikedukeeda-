                ...
                <form class="" name="addUserFrm" id="addUserFrm" type="POST" >
                    ...
                    <div class="form-row qual-div" id="qual-div-1" style="display:none;">
                        <div class="form-group col-md-3" >
                            <label>Expected Year of Degree Completion</label>
                            <input id="expYearDegreeCompletion" type="date" class="form-control" name="expYearDegreeCompletion" value="" >
                            <div class="invalid-feedback" id="error_validation_expYearDegreeCompletion"></div>
                        </div>
                        <div class="form-group col-md-3" >
                    ...
                    <div class="form-row qual-div" id="qual-div-2" style="display:none;">
                        <div class="form-group col-md-3" >
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6" >
                            ...
                            <input id="majorIdentity" type="text" class="form-control" name="majorIdentity" value="" >
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6" >
                            ...
                            <input id="moreAboutYou" type="text" class="form-control" name="moreAboutYou" value="" >
