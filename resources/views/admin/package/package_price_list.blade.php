                ...
                <form class="" name="editPackagePriceFrm" id="editPackagePriceFrm" type="POST">
                    ...
                    <div class="form-row ">
                        ...
                        <div class="form-group col-md-6" style="text-align:right; ">
                           <button type="button" id="package_price_edit_cancel" name="package_price_edit_cancel" class="btn btn-dialog" data-dismiss="modal" onclick="window.location.href='{{url('package-price/edit')}}'"><i style="color:#fff;" title="Edit Package" class="far fa-edit"></i> Edit</button>
                        </div>    
                    </div>  
